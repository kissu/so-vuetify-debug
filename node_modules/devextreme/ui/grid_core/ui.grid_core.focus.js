        ...
        controllers: {
            ...
            data: {
                ...
                _fireChanged: function(e) {
                    var isPartialUpdateWithDeleting = void 0;
            ...
            rowsView: {
                ...
                _setFocusedRowElementTabIndex: function() {
                    ...
                    if (rowElement) {
                        ...
                        (0, _renderer2.default)(rowElement).attr("tabIndex", tabIndex);
                        if (rowIndex >= 0) {
                            if (columnIndex < 0) {
                                columnIndex = 0
                            }
                ...
                scrollToElementVertically: function($element) {
                    ...
                    if (scrollable) {
                        var position = scrollable.getScrollElementPosition($element, "vertical");
                        scrollable.scrollTo({
                            top: position
                        })
                    }
