    ...
    _createClass(FileManager, [{
        ...
        value: function() {
            ...
            var actions = (0, _extend.extend)(this._editing.getCommandActions(), {
                refresh: function() {
                    return _this8._refreshAndShowProgress()
                },
                thumbnails: function() {
                    return _this8.option("itemView.mode", "thumbnails")
                },
                details: function() {
                    return _this8.option("itemView.mode", "details")
                },
                clear: function() {
                    return _this8._clearSelection()
                },
                showNavPane: function() {
                    return _this8._adaptivityControl.toggleDrawer()
                }
            });
        ...
        value: function() {
            ...
            return this._controller.refresh().then(function() {
                return _this9._redrawComponent()
            })
        }
    }, {
        key: "_updateToolbar",
